  ...
  <q-layout view="lHh Lpr lFf">
    <q-page-container>
      <q-page class="session-page column bg-white">
        <!-- Header -->
        <div
          class="row items-center justify-between q-pa-md shadow-1 z-top relative-position bg-white"
        >
          <q-btn flat round dense icon="arrow_back_ios" color="dark" @click="handleBack" />
          <div
            class="text-subtitle1 text-weight-bolder tracking-tight"
          ...
          <transition name="fade" mode="out-in">
            ...
            >
              <q-icon
                ...
                size="140px"
                color="info"
                class="q-mb-xl drop-shadow"
              />
              <div class="text-h4 text-weight-bolder text-dark tracking-tight q-mb-md">
                Get Ready
              </div>
            ...
            <!-- State: EXERCISING -->
            <div
              v-else-if="state === 'exercising'"
              key="exercising"
              class="column flex-center text-center full-width"
            >
              <!-- Visual Guide -->
              <div
                class="visual-guide q-mb-xl shadow-4 rounded-borders flex flex-center bg-grey-1 relative-position overflow-hidden"
              >
                <q-icon name="accessibility_new" size="110px" color="grey-5" />
                <div
                  class="absolute-bottom bg-dark text-white text-caption full-width q-py-xs text-weight-medium"
                  style="opacity: 0.85"
                >
                  Animation Demo
                </div>
              ...
              <div class="q-mt-md relative-position">
                ...
                >
                  <div class="column flex-center">
                    <div
                      class="text-caption text-weight-bold text-grey-6 text-uppercase tracking-wider"
                    >
                      Set {{ currentSet }}
                    </div>
                    <div class="row items-baseline q-mt-sm">
                      <span class="text-h2 text-weight-bolder text-dark" style="line-height: 1">{{
                        currentRep
                      }}</span>
                      <span class="text-h6 text-grey-6 text-weight-bold q-ml-xs"
                        >/ {{ currentExercise.reps }}</span
                      >
                    </div>
                    <div class="text-caption text-weight-bold text-grey-5 q-mt-md tracking-wider">
                      REPS
                    </div>
                  </div>
                </q-circular-progress>
            ...
            >
              ...
              <div class="text-h4 text-weight-bolder text-dark tracking-tight q-mb-sm">
                Exercise Completed
              </div>
              <div class="text-subtitle1 text-grey-7 text-weight-medium q-mb-xl">
                Get Ready for Next
              ...
              <q-btn
                ...
                color="grey-6"
                rounded
                label="ISSUES WITH THIS EXERCISE?"
                no-caps
                class="q-mb-xl text-weight-bold"
              />
            ...
            >
              ...
              <q-btn
                ...
                no-caps
                class="text-weight-bold shadow-4 q-px-xl"
                @click="handleBack"
              />
            </div>
          </transition>
        ...
        <div
          class="controls-bar row items-center justify-around q-px-md q-py-lg bg-white shadow-up-subtle relative-position"
          v-if="state === 'exercising' || state === 'rest'"
        >
          <q-btn flat round color="grey-5" icon="settings" size="sm" to="/profile" />
          <q-btn flat round color="primary" class="bg-blue-1" icon="fast_rewind" @click="prevEx" />

          <!-- Overlapping Center Play/Pause Button -->
          <div
            class="absolute-top text-center full-width"
            style="top: -42px; left: 0; pointer-events: none"
          >
            <q-btn
              round
...
.center-play-glow {
  box-shadow:
    0px 10px 30px rgba(16, 185, 129, 0.35),
